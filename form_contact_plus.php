...
# You will want to configure the following variables to suit your needs
	...
	$default_destination_email = "masupeco@hotmail.com";
#	$default_destination_email = "amecod@amecod.org";

	# The name of your website
	$site_name = "AMECOD";

	# The default followup URL in case one isn't supplied on the form.
	$default_followup_url = "gracias.htm";

	# The value of this variable will be displayed if the followup_url is not specified.
	$default_response = "Gracias por escribirnos.<br>Su opinión es muy importante para nosotros";
